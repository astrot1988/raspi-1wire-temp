 ...
 *
 * If the hint is supplied, this function assumes the base working directory is the root directory.
 *
 * @param {String} hint A glob to search for devices.
 * @returns {Array<String>} A list of device/file names that matched the optional or default glob.
 */
